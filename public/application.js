...
/***/ function(module, exports, __webpack_require__) {
	...
	var signInSuccess = function signInSuccess(input) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newBoard = function newBoard(event) {
	  ...
	  api.createGame(data).then(ui.createGameSuccess);
	  //  .catch(ui.createGameFailure)
	};
	// function to track game play, check for wins and log results
	var clickSquare = function clickSquare(event) {
	  ...
	  if (over === false) {
	    ...
	    if ($(this).text()) {
	      ...
	      if (currentTurn === 'x') {
	        ...
	        var _squareId = $(this).attr('id');
	        // mark the square with an 'O'
	        $(this).text('O');
	        // call makeMove function to add move into cells array
	        game.makeMove(currentTurn, _squareId, cells, over);
	        // call checkWinningCombos to see if game is over
	        over = game.checkWinningCombos(cells);
	        // create data structure expected by api
	        var _data = {
	...
	var getStats = function getStats(event) {
	  // prevent board from refreshing
	  event.preventDefault();
	  // run api call to get the statistics
	  api.index().then(ui.getGamesSuccess);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGamesSuccess = function getGamesSuccess(data) {
	  ...
	  var gamesWon = game.winCounter(data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkWinningCombos = function checkWinningCombos(gamearray) {
	  // check for winning combo 1
	  if (gamearray[0] === gamearray[1] && gamearray[1] === gamearray[2] && gamearray[2] !== '') {
	    var winningPlayer = gamearray[0];
	...
	var makeMove = function makeMove(playerId, squareId, newArray, gamestatus) {
	...
	var totalWins = function totalWins(gamearray) {
	...
	var winCounter = function winCounter(data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "1bc2a23cef99998f25e01668a3bd9f1d.jpg";
